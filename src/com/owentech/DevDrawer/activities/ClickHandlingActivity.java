...
public class ClickHandlingActivity extends Activity {
        ...
        if (packageName != null) {
            ...
            else
            {
                ...
                try {
                	...
                	Packageitems = adapter.toArray(new CharSequence[adapter.size()]);
                ...
                alert.setSingleChoiceItems(Packageitems, -1, new DialogInterface.OnClickListener() {

                    public void onClick(DialogInterface dialog, int item){
                    	Intent intent = new Intent();
                    	intent.setComponent(new ComponentName(packageName, Packageitems[item].toString()));
    ...
    private List<String> getActivityList(String packageName) throws NameNotFoundException {
